...
<div class="wrapper">
    ...
    <tbody>
      <table class="table">
        <tr>
          <th><img src="https://dsw.scene7.com/is/image/DSWShoes/343755_011_ss_05?$pdp-image$" alt="Img" class="product-grid__img" /></th>
          <th>
            <h4 class="product-grid__img"></h4><br>
            <h4 class="product-grid_img"></h4>
          </th>
          <th style="text-align:left">
            <h6 class="product-grid__img">
            <!-- Price :<br>  -->
            <!-- Quantity :<br><hr> -->
            ...
            <!-- Delivery Country:<br> -->
            Shipping Fee: {{ $shippingFee }}<br><hr>
